...
# arxiv_discoverer documentation build
...
from arxiv_discoverer import __version__ as release

# -- Project information -----------------------------------------------------

project = "arxiv_discoverer"
author = "Kedro"
...
htmlhelp_basename = "arxiv_discovererdoc"
...
latex_documents = [
    (
        master_doc,
        "arxiv_discoverer.tex",
        "arxiv_discoverer Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "arxiv_discoverer",
        "Project arxiv_discoverer codebase.",
        "Data-Science",
    )
]
